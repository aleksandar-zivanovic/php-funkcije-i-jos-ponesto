...
<div class="container">
    ...
    <h2>str_starts_with()</h2>
</div>

<?php
echo "<p style=\"font-size:1.2rem; padding: 1rem; background-color: #ffcccb;\">Proverava da li string počinje zadatim substringom. Pretraga je <strong>case-sensitive</strong>. Vraća TRUE ili FALSE.</p><hr>";
...
echo "<a href=\"str_ends_with.php\" target=\"_blank\">str_ends_with</a> <br>";
